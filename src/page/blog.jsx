        ...
        <motion.div variants={sectionVariants} className="lg:col-span-2">
          ...
          <motion.div className="w-full" variants={imageVariants}>
            <motion.img
              src={Property}
              alt="House"
              className="w-full h-60 md:h-100 object-cover rounded-xl"
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mt-6">
            <motion.div
              className="flex items-center gap-6 text-gray-600 text-sm my-2 "
              variants={containerVariants}
            >
              <motion.span
            ...
            >
              <div className="">
                ...
                >
                  ...
                  market. Learn about pricing shifts, emerging neighborhoods,
                  and key strategies to make informed decisions in 2025.
                </motion.p>
